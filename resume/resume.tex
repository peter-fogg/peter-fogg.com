...
\newcommand{\mywebheader}{
  \begin{tabular*}{7in}{l@{\extracolsep{\fill}}r}
    ...
    PO Box 719 &  \href{mailto:peter.p.fogg@gmail.com}{peter.p.fogg@gmail.com} \\
...
\begin{itemize}
\item
  \textbf{Programming Languages:} Python, Haskell, Javascript, Java, Scheme, Elixir
\item
  \textbf{Frameworks:} Django, Backbone
\item
